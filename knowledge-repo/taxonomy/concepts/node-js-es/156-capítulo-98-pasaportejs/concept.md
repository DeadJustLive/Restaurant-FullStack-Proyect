...
## Fuente
Capítulo 1: Empezando con Node.js 2 (Cap. 156)

## Contenido
# Capítulo 98:: pasaporte.js

Introducción
Passport es un módulo de autorización popular para el nodo. En palabras simples, maneja todas
las solicitudes de autorización de los usuarios en su aplicación. Passport admite más de 300
estrategias para que pueda integrar fácilmente el inicio de sesión con Facebook / Google o
cualquier otra red social que lo use. La estrategia que discutiremos aquí es el Local donde usted
autentica a un usuario utilizando su propia base de datos de usuarios registrados (con nombre de
