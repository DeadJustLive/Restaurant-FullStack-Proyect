...
## Fuente
Flowbite React - Componentes UI (Cap. 27)

## Contenido
# Use with Next.js - Flowbite React

> Fuente: [https://flowbite-react.com/docs/getting-started/quickstart](https://flowbite-react.com/docs/getting-started/quickstart)
