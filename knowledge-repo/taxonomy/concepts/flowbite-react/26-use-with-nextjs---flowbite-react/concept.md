...
## Fuente
Flowbite React - Componentes UI (Cap. 26)

## Contenido
# Use with Next.js - Flowbite React

> Fuente: [https://flowbite-react.com/docs/getting-started/introduction](https://flowbite-react.com/docs/getting-started/introduction)
