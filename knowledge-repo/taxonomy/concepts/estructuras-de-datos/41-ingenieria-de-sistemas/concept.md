...
4 0 0 2 0 1
5 0 0 0 2 0
La matriz denominada M se le conoce como matriz dispersa pues tiene la mayor cantidad de valores en la matriz
como ceros (se denomina así de manera intuitiva).
Existen dos formas para representar matrices dispersas, por extensión y por comprensión. por extensión usando
tripletas, y por comprensión utilizando fórmulas de direccionamiento.
