...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 23)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-renderizando-aplicaciones-de-redux-en-el-servidor](https://leanpub.com/read/react-redux/leanpub-auto-renderizando-aplicaciones-de-redux-en-el-servidor)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva funció
