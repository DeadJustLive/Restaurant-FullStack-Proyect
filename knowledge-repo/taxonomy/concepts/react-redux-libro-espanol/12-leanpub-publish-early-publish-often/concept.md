...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 12)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-componentes-de-alto-orden-en-reactjs](https://leanpub.com/read/react-redux/leanpub-auto-componentes-de-alto-orden-en-reactjs)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva función despachadora. A menudo c
