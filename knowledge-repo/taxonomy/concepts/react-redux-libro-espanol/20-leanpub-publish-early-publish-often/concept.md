...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 20)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-migrando-a-redux](https://leanpub.com/read/react-redux/leanpub-auto-migrando-a-redux)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva función despachadora. A menudo convierten acciones asíncronas en accione
