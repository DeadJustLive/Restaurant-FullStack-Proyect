...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 16)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-glosario-de-trminos](https://leanpub.com/read/react-redux/leanpub-auto-glosario-de-trminos)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva función despachadora. A menudo convierten acciones asíncronas en a
