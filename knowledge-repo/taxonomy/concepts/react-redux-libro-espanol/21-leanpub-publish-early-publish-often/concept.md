...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 21)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-obteniendo-datos-en-aplicaciones-de-redux](https://leanpub.com/read/react-redux/leanpub-auto-obteniendo-datos-en-aplicaciones-de-redux)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva función despachadora. 
