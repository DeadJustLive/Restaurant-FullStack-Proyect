...
## Fuente
Desarrollo de Apps Web con React.js y Redux.js (Cap. 19)

## Contenido
# Leanpub: Publish Early, Publish Often

> Fuente: [https://leanpub.com/read/react-redux/leanpub-auto-middlewares-en-reduxjs](https://leanpub.com/read/react-redux/leanpub-auto-middlewares-en-reduxjs)
...
Un middleware es una función de orden superior que toma una función despachadora y devuelve una nueva función despachadora. A menudo convierten acciones asíncrona
