...
## Fuente
El Lenguaje de Programación Rust (Libro Oficial en Español) (Cap. 43)
...
#### Ignorando un Valor Completo con_

#### Ignorando partes de un valor con un_anidado

#### Ignorando una variable no utilizada comenzando su nombre con_
