...
## Fuente
El Lenguaje de Programación Rust (Libro Oficial en Español) (Cap. 7)
...
consultela etiqueta de traduccionespara ayudar o informarnos sobre
...
- 15.Smart Pointers
- 15.1.Usando Box<T> para Apuntar a Datos en el Heap15.2.Tratando los Smart Pointers como Referencias Regulares con el Trait Deref15.3.Ejecutando Código al Limpiar con el Trait Drop15.4.Rc<T>, el Smart Pointer de Conte
