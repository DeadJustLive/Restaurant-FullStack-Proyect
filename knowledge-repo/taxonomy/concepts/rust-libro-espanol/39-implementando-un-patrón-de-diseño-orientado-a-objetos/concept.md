...
## Fuente
El Lenguaje de Programación Rust (Libro Oficial en Español) (Cap. 39)

## Contenido
## Implementando un patrón de diseño orientado a objetos

### DefiniendoPosty creando una nueva instancia en el estado de borrador
...
### Agregandoapprovepara cambiar el comportamiento decontent
