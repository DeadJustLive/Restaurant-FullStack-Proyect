...
## Fuente
CapacitorJS — Documentación Oficial (Cap. 46)
...
Phaseris one of the most popular web-based game development engines.

To get started building games with Capacitor and Phaser, see theBring your Phaser game to iOS and Android with Capacitor
