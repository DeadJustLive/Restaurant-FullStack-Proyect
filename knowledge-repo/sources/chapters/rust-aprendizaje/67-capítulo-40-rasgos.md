...
Al definir un nuevo rasgo, es posible imponer que los tipos que deseen implementar este rasgo
verifiquen una serie de restricciones o límites.
Tomando un ejemplo de la biblioteca estándar, el rasgo DerefMut requiere que un tipo implemente
primero su rasgo Deref hermano:
