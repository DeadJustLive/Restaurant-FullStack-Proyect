...
1En algunos lenguajes de programaci´on como por ejemplo C y Java, los ´ındices
comienzan en cero.
2En lenguajes como C y Java es el tama˜no del arreglo menos uno, debido a que la
primera posici´on (´ındice 0) tambi´en es contada.

-- 354 of 450 --

Introducci ´on a la L ´ogica de Programaci ´on 353
Ejemplos de creaci´on de arreglos con la funci´on
dimensionar() :