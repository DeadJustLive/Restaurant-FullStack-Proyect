...
configuración no sea final se alternan una llamada al algoritmo anterior (juegaElComputador) y una petición de jugada
al usuario.
...
fsi
fin
La función utilidad es la que implementa un recorrido exhaustivo del árbol de juego para encontrar la solución
mediante la estrategia minimax. El algoritmo puede mejorarse fácilmente si se conocen los valores máximo y mínimo que
