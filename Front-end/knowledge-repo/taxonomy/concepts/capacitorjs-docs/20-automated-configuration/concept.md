...
## Fuente
CapacitorJS — Documentación Oficial (Cap. 20)
...
To start, consult the official Apple documentation onSubmitting Apps to the App Store.See herefor details on generating splash screens and icons for your app.
