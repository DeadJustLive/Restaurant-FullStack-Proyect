...
## Fuente
Capítulo 1: Empezando con Node.js 2 (Cap. 33)
...
process.argv es una matriz que contiene los argumentos de la línea de comandos. El primer
elemento será node , el segundo elemento será el nombre del archivo JavaScript. Los siguientes
elementos serán los argumentos de línea de comando adicionales.
Ejemplo de código:
...
Aquí, en el bucle for (i = 2; i < process.argv.length; i++) bucle comienza con 2 porque los dos
primeros elementos de la matriz process.argv siempre son ['path/to/node.exe',
'path/to/js/file', ...]
Conversión a número Number(process.argv[i]) porque los elementos de la matriz process.argv
siempre son cadenas
