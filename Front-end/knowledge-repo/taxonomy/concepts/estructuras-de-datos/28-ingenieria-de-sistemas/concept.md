...
while ( cola.esvacia<>vacia) do // ciclo para preguntar por visitados
...
fin(while)
fin(BFS)
La determinación de los vértices w adyacentes a un vértice v dependerá de la forma como se tenga
representado el grafo.
