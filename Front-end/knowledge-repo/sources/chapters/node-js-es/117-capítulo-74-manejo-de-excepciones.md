...
En una nota al margen, también había una forma de manejar las excepciones con Clústeres y
Dominios .
Los dominios están en desuso más información aquí .
Errores y promesas
Las promesas manejan los errores de manera diferente al código sincrónico o de devolución de
llamada.
...
Actualmente, los errores que se lanzan en una promesa que no se captura provocan que el error
se trague, lo que puede dificultar la localización del error. Esto se puede resolver utilizando
herramientas de alineación como eslint o asegurándose de que siempre tenga una cláusula catch
.
Este comportamiento está en desuso en el nodo 8 a favor de terminar el proceso del nodo.
Lea Manejo de excepciones en línea: https://riptutorial.com/es/node-js/topic/2819/manejo-de-
excepciones
