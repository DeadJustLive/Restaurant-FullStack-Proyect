...
An´alisis del problema:
Resultados esperados: un mensaje de acuerdo a la respuesta del
ni˜no y la calificaci´on obtenida en cada tabla.
Datos disponibles: el n´umero de la tabla que desea repasar.
Proceso: se requiere de dos procesos repetitivos anidados. El interno
debe calcular la tabla que el ni˜no solicite, desde la fila 1 hasta la fila