...
operaciones de suma o resta, sino que se involucran operaciones de
multiplicaci´on o divisi´on:
acumulador = acumulador * valorIncremento
acumulador = acumulador / valorDecremento
Aclaraci´on:
Se debe tener especial cuidado en la inicializaci´on del
acumulador cuando se trabaje con multiplicaciones,
su valor inicial no puede ser 0, debido a que todas las
operaciones realizadas con ´el dar´ıan como resultado