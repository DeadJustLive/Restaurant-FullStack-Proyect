...
La segunda forma utiliza el polimorfismo en tiempo de compilación, solo se muestran las
diferencias aquí:
trait Shape {
...
Lea Rust orientado a objetos en línea: https://riptutorial.com/es/rust/topic/6737/rust-orientado-a-
objetos
