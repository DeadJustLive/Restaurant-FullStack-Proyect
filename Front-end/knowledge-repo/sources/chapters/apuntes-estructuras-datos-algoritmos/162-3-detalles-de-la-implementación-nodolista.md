...
de la cadena, puesto que, en cada nivel del árbol, debido a la representación nodo–lista, puede ser necesario recorrer una
lista de longitud máxima igual al cardinal del dominio de valores del tipo carácter.
