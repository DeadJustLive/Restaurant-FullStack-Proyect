...
De acuerdo a lo que se indica en el sitio web en que se difunde este protocolo, la
forma de ingresar la información correspondiente a la <ubicación del sitemap>
debe 	ser 	la 	URL 	completa 	del 	Sitemap, 	como 	por 	ejemplo:
http://www.sitioweb.gob.cl/sitemap.xml.
Mediante una solicitud http desde el browser: para hacerlo se debe utilizar el
propio browser y en la línea de la dirección escribir lo siguiente:
